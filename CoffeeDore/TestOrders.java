...
public class TestOrders {
    public static void main(String[] args) {
        ...
        CoffeeKiosk koisk = new CoffeeKiosk();
        koisk.addMenuItem("Chai", 35);
        koisk.addMenuItem("tea", 5);
        koisk.addMenuItem("herbaltea", 6.5);
        // koisk.newOrder();

        koisk.addMenuItemByInput();
        System.out.println(koisk.getmenu());
